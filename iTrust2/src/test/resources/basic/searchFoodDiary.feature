...
Given <pt> has a diary entry on <date> that he ate <servings> servings of <food> for <meal> that had: <fat>g fat, <sodium>mg sodium, <carbs>g carbs, <sugar>g sugar, <fiber>g fiber and <protein>g protein.
When I search for <pt>'s diary entries
Then I see a diary entry on <date> that he ate <servings> servings of <food> for <meal> that had: <fat>g fat, <sodium>mg sodium, <carbs>g carbs, <sugar>g sugar, <fiber>g fiber and <protein>g protein.
...
When <pt> has a diary entry entry on 1/01/2018 for <servings> servings of Apple for SNACK that had: <fat>g fat, <sodium>mg sodium, <carbs>g carbs, <sugar>g sugar, <fiber>g fiber and <protein>g protein.
